                ...
                <div class="table-responsive small">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if($userLevel == 'Dosen') {
                                $query = "SELECT d.nama_dosen AS nama, p.time AS waktu, u.level AS status, p.status AS keterangan, p.id_peminjaman AS id FROM peminjaman AS p
                                ...
                                $query = "SELECT m.nama_mhs AS nama, p.time AS waktu, u.level AS status, p.status AS keterangan, p.id_peminjaman AS id FROM peminjaman AS p
                                        INNER JOIN user AS u ON u.user_id = p.user_id
